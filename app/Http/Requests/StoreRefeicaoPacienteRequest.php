...
class StoreRefeicaoPacienteRequest extends FormRequest
{
    /**
    ...
    {
        return [
            "refeicao_id.required"  => "O tipo de exercício não foi informado",
            "refeicao_id.numeric"   => "Tipo de exercício inválido",
