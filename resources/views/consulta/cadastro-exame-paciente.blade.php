        ...
        <div class="card-body">
            <form method="POST" action="{{ route('nutricionista.salvar.exame.paciente') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" placeholder="dd/mm/yyyy" class="form-control" id="data_realizacao"
                        name="data_realizacao" required>
                </div>
                <button class="btn btn-outline-secondary" type="button" id="button-addon1"
                    onclick="document.location='{{ route('nutricionista.listar.exame.paciente', $id) }}'">Listar Exames</button>
