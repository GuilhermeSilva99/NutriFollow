        ...
        <div class="card-body">
            <form method="POST" action="{{route('nutricionista.atualizar.exame.paciente', $exame->id ) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" value="{{ $exame->nome }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" placeholder="dd/mm/yyyy" class="form-control" id="data_diagnostico" name="data_diagnostico" value="{{ $exame->data_realizacao }}">
                </div>
